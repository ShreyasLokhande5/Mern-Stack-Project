  ...
  return productData ? (
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1 ">
          ...
          <p className="mt-5 twxt-3x1 font-medium">{currency}{productData.price}</p>
    ...
    <div className="mt-20">
      ...
      <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
        <p>Explore a diverse range of products from the comfort of your home with our user-friendly eCommerce site. From browsing to checkout, our eCommerce website is crafted to deliver a smooth and enjoyable shopping journey. Shop smarter, not harder—our eCommerce website offers a vast selection, competitive prices, and fast delivery.</p>
